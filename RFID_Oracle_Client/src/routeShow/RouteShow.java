...
public class RouteShow extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelName.setFont(new java.awt.Font("幼圆", 1, 18));
        ...
        jbt.setFont(new java.awt.Font("宋体", 0, 18));
        jbt.setText("查询");
        ...
        jp_show.setBackground(new java.awt.Color(204, 204, 255));
        jScrollPane1.setViewportView(jp_show);
...
public static void main(String args []){
   ...
   String action[]={"出库","进入/1406","离开1406","进入/仓库"};
    
    	JFrame jf = new JFrame();
    	RouteShow route = new RouteShow();
    	jf.add(route);
